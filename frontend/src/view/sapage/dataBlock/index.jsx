          ...
          >
                  ...
                  <Tooltip
                    title={
                      <Typography color="inherit">
                        Please choose one of the three options for data input:
                        Upload data, Query, Use Previous data.
                      </Typography>
                    }
                    placement="top"
                    arrow
            ...
            <Grid item xs={4} sx={gridItemStyle}>
              <FormControl variant="outlined" fullWidth>
                ...
                >
                  <MenuItem value={"European (EUR)"}>European(EUR)</MenuItem>
              ...
              >
                ...
                >
                  <Tooltip
                    title={
                      <Typography color="inherit">
                        Entering the column names of your input data is optional
                        but recommended. If not provided, we will automatically
                        detect the column names of your input data
                      </Typography>
                    }
                    placement="top"
                    arrow
              ...
              >
                ...
                >
                  <Tooltip
                    title={
                      <Typography color="inherit">
                        Please select the human genome build version of your
                        input data.
                      </Typography>
                    }
                    placement="top"
